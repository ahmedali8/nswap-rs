...
use nswap::ContractContract as Exchange;
use nswap::PoolInfo;
...
mod fuzzy;
use fuzzy::{
    constants::*, liquidity_manage::*, pool_swap::*, types::*, utils::*,
};
...
fn do_operation(
    ...
    match operator.preference {
        ...
        StablePreference::RemoveLiquidityByShare => {
            do_stable_remove_liquidity_by_shares(
                token_contracts,
                rng,
                root,
                operator,
